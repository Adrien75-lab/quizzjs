...
// On prend tous les blocks, on utilise forEach qui parcourt le block de question,
// On est à l'écoute d'un évènement lequel donc sur le click et donc si on clique sur un block,
// On modifie la couleur et on la change en blanc;
//
